...
namespace Al_Basit_Corporation.Models
{
	...
	public partial class investerdetailDataClassesDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Inserttblinvsterdetail(tblinvsterdetail instance);
    partial void Updatetblinvsterdetail(tblinvsterdetail instance);
    partial void Deletetblinvsterdetail(tblinvsterdetail instance);
    #endregion
		
		public investerdetailDataClassesDataContext() : 
				base(global::Al_Basit_Corporation.Properties.Settings.Default.AlbbasitcorporationConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public investerdetailDataClassesDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public investerdetailDataClassesDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public investerdetailDataClassesDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public investerdetailDataClassesDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<tblinvsterdetail> tblinvsterdetails
		{
			get
			{
				return this.GetTable<tblinvsterdetail>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblinvsterdetail")]
	public partial class tblinvsterdetail : INotifyPropertyChanging, INotifyPropertyChanged
	{
