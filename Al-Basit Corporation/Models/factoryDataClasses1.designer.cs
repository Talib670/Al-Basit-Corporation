...
namespace Al_Basit_Corporation.Models
{
	...
	public partial class factoryDataClasses1DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Deletetblfactory(tblfactory instance);
		...
		public factoryDataClasses1DataContext() : 
				base(global::Al_Basit_Corporation.Properties.Settings.Default.AlbbasitcorporationConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public factoryDataClasses1DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public factoryDataClasses1DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public factoryDataClasses1DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public factoryDataClasses1DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnBqaya_AmountChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[Industry Name]", Storage="_Industry_Name", DbType="NVarChar(100)")]
