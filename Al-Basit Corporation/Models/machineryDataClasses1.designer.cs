...
namespace Al_Basit_Corporation.Models
{
	...
	public partial class machineryDataClasses1DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Inserttblmachinery(tblmachinery instance);
    partial void Updatetblmachinery(tblmachinery instance);
    partial void Deletetblmachinery(tblmachinery instance);
    #endregion
		
		public machineryDataClasses1DataContext() : 
				base(global::Al_Basit_Corporation.Properties.Settings.Default.AlbbasitcorporationConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public machineryDataClasses1DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public machineryDataClasses1DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public machineryDataClasses1DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public machineryDataClasses1DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<tblmachinery> tblmachineries
		{
			get
			{
				return this.GetTable<tblmachinery>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblmachinery")]
	public partial class tblmachinery : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _Machinery_Name;
    ...
    partial void OnMachinery_NameChanging(string value);
    partial void OnMachinery_NameChanged();
    ...
    partial void OnBqaya_AmountChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[Machinery Name]", Storage="_Machinery_Name", DbType="NVarChar(100)")]
		public string Machinery_Name
		{
			get
			{
				return this._Machinery_Name;
			}
			set
			{
				if ((this._Machinery_Name != value))
				{
					this.OnMachinery_NameChanging(value);
					this.SendPropertyChanging();
					this._Machinery_Name = value;
					this.SendPropertyChanged("Machinery_Name");
					this.OnMachinery_NameChanged();
				}
			}
		}
