...
namespace Al_Basit_Corporation.Models
{
	...
	public partial class petrolDataClasses1DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Inserttblpetrol(tblpetrol instance);
    partial void Updatetblpetrol(tblpetrol instance);
    partial void Deletetblpetrol(tblpetrol instance);
    #endregion
		
		public petrolDataClasses1DataContext() : 
				base(global::Al_Basit_Corporation.Properties.Settings.Default.AlbbasitcorporationConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public petrolDataClasses1DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public petrolDataClasses1DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public petrolDataClasses1DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public petrolDataClasses1DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<tblpetrol> tblpetrols
		{
			get
			{
				return this.GetTable<tblpetrol>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblpetrol")]
	public partial class tblpetrol : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnBqaya_AmountChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[Station Name]", Storage="_Station_Name", DbType="NVarChar(100)")]
