...
namespace Al_Basit_Corporation.Models
{
	...
	public partial class investerDataClasses1DataContext : System.Data.Linq.DataContext
	{
    ...
    partial void Inserttblinvester(tblinvester instance);
    partial void Updatetblinvester(tblinvester instance);
    partial void Deletetblinvester(tblinvester instance);
    #endregion
		
		public investerDataClasses1DataContext() : 
				base(global::Al_Basit_Corporation.Properties.Settings.Default.AlbbasitcorporationConnectionString, mappingSource)
		{
			OnCreated();
		}
		
		public investerDataClasses1DataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public investerDataClasses1DataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public investerDataClasses1DataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public investerDataClasses1DataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<tblinvester> tblinvesters
		{
			get
			{
				return this.GetTable<tblinvester>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.tblinvester")]
	public partial class tblinvester : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OnInvester_NameChanging(string value);
    partial void OnInvester_NameChanged();
    ...
    partial void OnBqaya_AmountChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="[Invester Name]", Storage="_Invester_Name", DbType="NVarChar(100)")]
		public string Invester_Name
		{
			get
			{
				return this._Invester_Name;
			}
			set
			{
				if ((this._Invester_Name != value))
				{
					this.OnInvester_NameChanging(value);
					this.SendPropertyChanging();
					this._Invester_Name = value;
					this.SendPropertyChanged("Invester_Name");
					this.OnInvester_NameChanged();
				}
			}
		}
