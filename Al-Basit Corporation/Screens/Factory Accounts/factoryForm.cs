...
{
    public partial class factoryForm : Form4
    {
        factoryDataClasses1DataContext fd = new factoryDataClasses1DataContext();
        ...
        private void factoryForm_Load(object sender, EventArgs e)
        {
            ...
            label5.Visible = false;
            {
                SqlConnection conn = new SqlConnection(DecHelper.ConnectionString);
                conn.Open();
                string str = "  Select * FROM [Albbasitcorporation].[dbo].[factorybqayaamount]";
        ...
        {
            {
                SqlConnection conn = new SqlConnection(DecHelper.ConnectionString);
                conn.Open();
                string str = "  Select * FROM [Albbasitcorporation].[dbo].[factorybqayaamount] WHERE  [namefactory]= '" + comboBox1.Text + "'";
                SqlCommand cmd = new SqlCommand(str, conn);
                SqlDataReader da = cmd.ExecuteReader();
                while (da.Read())
                {
...
SET [Grand Total] = '" + total.Text + "'";
                ...
                t.Industry_Name = comboBox1.Text;

                fd.tblfactories.InsertOnSubmit(t);
                fd.SubmitChanges();
                MessageBox.Show("Industry Record Save SuccessFully...!!!", "Save", MessageBoxButtons.OK, MessageBoxIcon.Information);
...

                {
                    ...
                    string str = @" UPDATE [Albbasitcorporation].[dbo].[factorybqayaamount]
SET [bqayaamount]= '" + bqayatextBox1.Text + "'  WHERE [namefactory] = '" + comboBox1.Text + "'";
        ...
        {
            newfactoryForm1 nf = new newfactoryForm1();
            nf.ShowDialog();
        ...
        {
            reportsfactoryForm1 rf = new reportsfactoryForm1();
            rf.ShowDialog();
        }
        ...
        private void jummatextBox_TextChanged_1(object sender, EventArgs e)
        {
